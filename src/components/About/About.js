...
const About = () => {
  return (
    <div className=" bg-neutral" id="about">
      <h1 className="text-center text-3xl font-bold p-20">About <span className="text-orange-500">Us</span></h1>
      <div>
        <div class="hero min-h-screen">
          ...
          data-aos-duration="2000" className="ml-40">
