      ...
      >
        <div class="card w-96 bg-base-100 shadow-xl hover:bg-orange-500">
          <figure class="px-10 pt-10">
            <img src={icon} alt="Shoes" class="rounded-xl w-48" />
          </figure>
          <div class="card-body items-center text-center">
            <h2 class="card-title">Web Design</h2>
            <p>
              A web designer creates the layout and design of a website. In
              simple terms, a website designer makes a site look good. They use
              design programs to create visual elements
            </p>
          </div>
        </div>
        <div class="card w-96 bg-base-100 shadow-xl hover:bg-orange-500">
          <figure class="px-10 pt-10">
            <img src={icon1} alt="Shoes" class="rounded-xl w-40" />
          </figure>
          <div class="card-body items-center text-center">
        ...
        <div class="card w-96 bg-base-100 shadow-xl hover:bg-orange-500">
          <figure class="px-10 pt-10">
            <img src={icon3} alt="Shoes" class="rounded-xl w-64" />
          </figure>
          <div class="card-body items-center text-center">
            <h2 class="card-title">backend developer</h2>
            <p>
              Though requirements vary between jobs, back end developers will
              need to have a passing familiarity with, if not command of,
              several technical languages and programs. These essential back end
              developer skills include but are not limited to: Node js,Express
              js,Mongodb
            </p>
          </div>
        </div>
